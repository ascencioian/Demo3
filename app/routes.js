...
// GET routes ===============================================================
  ...
  app.get('/profile', isLoggedIn, function(req, res) {
     //only find posts posted by the signed in user req.user._id(logged in users ID)
      db.collection('content').find({postedBy: req.user._id}).toArray((err, result) => {
...
// post routes used to bookmark content
...
// UNLINK ACCOUNTS =============================================================
// =============================================================================
// for local account, remove email and password from being used again.
